...
<template>
    ...
    <Modal class="bg-white max-w-md p-12">
        ...
        <h2 class="text-center text-2xl font-bold font-mono text-gray-900 border-b-2 pd-2">Sign In</h2>
        ...
        <form class="mt-6 space-y-6" v-on:submit.prevent="form.post(`/login`)">
            ...
            <div class="flex items-center justify-between">
                <div class="flex item-center">
                    <input type="checkbox" id="remember" class="h-4 w-4 text-blue-500 focus:ring-blue-500" />
